...
* [d] Nest two similar events somewhere in the site and prevent the event propagation properly. Remember not all event types bubble.
* [d ] Stop the navigation items from refreshing the page by using `preventDefault()`
